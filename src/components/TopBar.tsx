              ...
              <div className="container m-auto pt-3 pb-[11px]">
                  <div className="justify-between items-start flex max-xl:px-3">
                      ...
                      <div className="max-xl:hidden flex-col justify-center items-end inline-flex">
                          <div className="justify-start items-start inline-flex 2xl:gap-6 gap-6 xl:gap-3">
                              {Menu.map(({ icon, text,link }) => (
                              <div className="self-stretch group" key={text}>
                                  <a href={link} className="flex-col justify-start items-start flex">
                      ...
                      <div className="max-xl:hidden py-[3.80px] justify-start items-center gap-3 flex">
                      ...
                      <div className="xl:hidden">
                          <div className="justify-start items-end flex" onClick={() => handleClickMobile()}>
                              <div className="w-12 h-12 p-3 justify-center items-center inline-flex">
                              </div>
